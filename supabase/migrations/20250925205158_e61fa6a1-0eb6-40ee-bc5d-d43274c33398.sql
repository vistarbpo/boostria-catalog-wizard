...
-- Update the first function with proper search_path
DROP FUNCTION IF EXISTS create_sample_products_for_user(UUID);
...
-- Update the second function with proper search_path
DROP FUNCTION IF EXISTS public.create_my_sample_products();
